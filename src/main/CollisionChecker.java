...
public class CollisionChecker {
    ...
    public void checkPlayer(Entity entity) {
        ...
        tileNum3=em.tileM.mapTileNum[entityMiddlecol] [entityTopRow].tileNum;
        if (em.tileM.tile[tileNum1].collision==true || em.tileM.tile[tileNum2].collision==true || em.tileM.tile[tileNum3].collision==true) {
            if (em.tileM.tile[tileNum1].grounded==false || em.tileM.tile[tileNum2].grounded==false || em.tileM.tile[tileNum3].grounded==false) {
                entity.velocityY=5;
                ceiling=true;
            }
        }
